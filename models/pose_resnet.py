...
class FCN(nn.Module):
    def __init__(self):
        ...
        self.relu = nn.ReLU(inplace=True)
        self.fc1 = nn.Conv2d(128 * 16, 128 * 16, kernel_size=1, bias=False)
        self.bn2 = nn.BatchNorm2d(128 * 16)
        self.fc2 = nn.Conv2d(128 * 16, 128 * 16, kernel_size=1)
        self.bn3 = nn.BatchNorm2d(128 * 16)
        self.fc3 = nn.Conv2d(128 * 16, 16, kernel_size=1)
    def forward(self, x):
